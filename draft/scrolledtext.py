...
class ScrolledText(Frame):
    ...
    def settext(self, text='', file=None):
        #TODO: sys.stdout, don't work
        #if file:
           #text = open(file, 'r').read()
           #self.text.insert(END, text)                    # add at line 1, col 0
           #self.text.insert(END, file.write())                    # add at line 1, col 0
        #self.text.delete('1.0', END)                     # delete current text
        
        #use stdout=sub.PIPE
        for line in file:
            self.text.insert(END, line)                    # add at line 1, col 0

        #self.text.mark_set(INSERT, '2.5')                # set insert cursor
